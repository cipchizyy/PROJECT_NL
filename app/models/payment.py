...
class Payment(db.Model):
    ...
    reservation_id = db.Column(
        db.String(36), db.ForeignKey("reservations.id"), nullable=False, unique=True
    )
    ...
    cashless_reference = db.Column(
        db.String(150), nullable=True
    )  # ← ini yang dipakai, bukan "reference"
